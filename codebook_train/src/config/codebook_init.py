from torch.nn.init import uniform_, normal_, orthogonal_, xavier_normal_, xavier_uniform_, constant_, sparse_
...
config_store.store(group="codebook_init", name="uniform", node=UniformInitializationConfig)
config_store.store(group="codebook_init", name="normal", node=NormalInitializationConfig)
config_store.store(group="codebook_init", name="orthogonal", node=OrthogonalInitializationConfig)
config_store.store(group="codebook_init", name="xavier_normal", node=XavierNormalInitializationConfig)
config_store.store(group="codebook_init", name="xavier_uniform", node=XavierUniformInitializationConfig)
config_store.store(group="codebook_init", name="constant", node=ConstantInitializationConfig)
config_store.store(group="codebook_init", name="sparse", node=SparseInitializationConfig)
