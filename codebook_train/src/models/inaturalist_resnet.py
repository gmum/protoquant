...
"""
Source: https://github.com/anguyen8/visual-correspondence-XAI/blob/main/ResNet-50/CUB-iNaturalist/ResNet-Naturalist.ipynb
...
def inaturalist_resnet50(num_classes: int = 1000, zero_init_residual: bool = False) -> ResNet_AvgPool_classifier:
    ...
    Returns:
        ResNet_AvgPool_classifier: The ResNet-50 model.
    """

    return ResNet_AvgPool_classifier(
        block=Bottleneck,
        layers=[3, 4, 6, 4],
