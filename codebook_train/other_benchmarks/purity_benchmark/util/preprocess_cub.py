...
path = '/net/scratch/hscra/plgrid/plgjanumiko/datasets/cub200/CUB_200_2011/'

time_start = time.time()

path_images = os.path.join(path,'images.txt')
path_split = os.path.join(path,'train_test_split.txt')
train_save_path = os.path.join(path,'pipnet/train_crop/')
test_save_path = os.path.join(path,'pipnet/test_crop/')
...
train_save_path = os.path.join(path,'pipnet/train/')
test_save_path = os.path.join(path,'pipnet/test_full/')
