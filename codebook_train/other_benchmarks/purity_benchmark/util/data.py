...
def get_data(args: argparse.Namespace): 
    ...
    if args.dataset =='CUB-200-2011':
        if not args.cub_data_path:
            raise ValueError("For CUB-200-2011 dataset, please provide the path to the dataset using --cub_data_path")
        
        base_path = args.cub_data_path
        train_crop_path = f"{base_path}/pipnet/train_crop"
        train_full_path = f"{base_path}/pipnet/train"
        test_crop_path = f"{base_path}/pipnet/test_crop"
        test_full_path = f"{base_path}/pipnet/test_full"
        return get_birds(True, train_crop_path, train_full_path, test_crop_path, args.image_size, args.seed, args.validation_size, train_full_path, test_full_path)
